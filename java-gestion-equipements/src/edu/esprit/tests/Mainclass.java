...
public class Mainclass {
    public static void main(String[] args) {
     ...
     Employe p1 = new Employe("kbair","molka","123475856",20,1200,23347685);
      pcd.ajouter2(p1);
// Modifier la quantité des equipements avec l'id 2
        Employe p2 = new Employe("kbaier","fathi","123475856",40,1200,23347665);
       
       pcd.ajouter2(p2);
       
       Employe p3 = new Employe("kebaier","fathi","123475856",50,1200,23347678);
       pcd.ajouter2(p3);
