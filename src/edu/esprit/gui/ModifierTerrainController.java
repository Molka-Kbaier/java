...
private Terrain terrainAModifier; // Ajouter une variable de classe pour stocker la culture sélectionnée

    public void initData(Terrain terrain) {
        terrainAModifier = terrain; // Stocker la culture sélectionnée dans la variable
...
Stage stage = (Stage) btnModifier.getScene().getWindow();
    ...
    @FXML
    private void selectImage(ActionEvent event) {FileChooser fileChooser = new FileChooser();
    fileChooser.setTitle("Choisir une image");
    fileChooser.getExtensionFilters().addAll(
