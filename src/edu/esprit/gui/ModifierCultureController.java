...
public class ModifierCultureController implements Initializable {
 ...
 private Culture cultureAModifier; // Ajouter une variable de classe pour stocker la culture sélectionnée

    public void initData(Culture culture) {
        cultureAModifier = culture; // Stocker la culture sélectionnée dans la variable
...
// Récupération de l'instance du contrôleur AfficherCultureController
...
//afficherCultureController.modifierCulture(cultureToUpdate);
            ...
            cultureAModifier.setType(type); // Mettre à jour la culture sélectionnée
...
Stage stage = (Stage) btnModifier.getScene().getWindow();
    ...
    /* public void initData(Culture culture) {
    // Initialisation des champs de texte avec les données de la culture sélectionnée
    tfType.setText(culture.getType());
